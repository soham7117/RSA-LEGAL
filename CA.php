...
<body>
    ...
    {       
        ...
        $sql = "INSERT INTO `ca`(`email`,`approval`,`firstPartyName`, `firstPartyAddress`, `secondPartyName`, `secondPartyAddress`, `document`,`photo`,`noOfMonths`, `startDate`, `endDate`, `premises`, `terms`) VALUES ('$email','$approval','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$folder','$folder1','$ContractLength','$LiveDate','$EndDate','$premises','$terms')";
        $mysqli->query($sql);
