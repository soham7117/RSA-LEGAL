...
<head>
    ...
    <title>PGA-Advanced Rent & Deposit</title>
    <style>
        body{
    ...
    <section class="bg-02-a">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="_head_01">
                        <h2>PGA-Advanced Rent & Deposit</h2>

                        <p>Home<i class="fas fa-angle-right"></i><span>PGA-Advanced Rent & Deposit</span></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- database -->
    ...
    { 
        ...
        $sql = "INSERT INTO `PGA`(`email`,`approval`,`firstPartyName`, `firstPartyAddress`, `secondPartyName`, `secondPartyAddress`,`Witness1`,`Witness2`,`document`,`photo` ,`noOfMonths`, `startDate`, `endDate`, `rent`, `rentxmonths`, `deposit`, `total`) VALUES ('$email','$approval','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$witness1','$witness2','$folder','$folder1','$ContractLength','$LiveDate','$EndDate','$rent','$rentxmonths','$deposit','$total')";
        $mysqli->query($sql);
        // header("location:PGA.php");
        
    }
    ?>
    <p align="right">
<input type="button" onclick="window.location.href = 'assets/database/logout.php';"  value="Logout"></input></p>
<form method="POST" enctype="multipart/form-data">
  ...
  <table class="center">
      <tr>
              <td></td>
              <td colspan="2">PGA-Advanced Rent & Deposit</td>
